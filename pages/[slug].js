...
function Post(props) {
  ...
  const url = `https://rycerzes.github.io/${props.slug}`
  const date = new Date(props.date).toISOString()
  const image = props.image
    ? `https://rycerzes.github.io${props.image}`
    : 'https://rycerzes.github.io/static/images/home-opt.jpg'
...
export async function getStaticProps({ params }) {
  try {
    ...
    const base = isProd ? 'https://rycerzes.github.io' : 'http://localhost:3000'
